...
import (
	...
	application "github.com/IsaqueAmorim/hexagonal-architecture/application"
...
func (m *MockProductServiceInterface) Create(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
